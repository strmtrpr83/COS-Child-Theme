...
function cos_child_theme_customize_register($wp_customize)
{
	...
	$wp_customize->add_setting(
		'cos_child_gravity_save_entries',
		array(
			'default' => 0,
			'transport'	=> 'refresh',
	...
	$wp_customize->add_setting(
		'cos_child_show_post_featured_image',
		array(
			'default' => 0,
			'transport'	=> 'refresh',
			'sanitize_callback' => 'cos_child_theme_sanitize_checkbox'
 ...
 * @since 1.0.29
 **/
function cos_custom_color_palette()
{
...
add_action('after_setup_theme', 'cos_custom_color_palette');
 ...
 * @since 1.0.30
 **/
function cos_gutenberg_css()
{
	add_theme_support('editor-styles');
	add_editor_style('cos-style-editor.css');
}
add_action('after_setup_theme', 'cos_gutenberg_css');
